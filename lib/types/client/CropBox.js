...
export function CropBox({ previewUrl, zoomX, zoomY, posX, posY, onChange, onCommit }) {
    ...
    const emit = useCallback((left, top, right, bottom, W, H) => {
    ...
    return (_jsx("div", { ref: boxRef, style: {
        ...
        }, children: _jsx("div", { onPointerDown: onPointerDown('move'), style: {
                position: 'absolute',
            ...
            }, children: HANDLES.map(({ id, style }) => (_jsx("div", { onPointerDown: onPointerDown(id), style: {
                    position: 'absolute',
                    width: 12, height: 12,
...
//# sourceMappingURL=CropBox.js.map